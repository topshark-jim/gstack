---
name: review
description: Pre-landing PR review. Use when the user wants a structural review of a diff against main for concurrency risks, trust-boundary bugs, data safety issues, and missing test coverage.
---
