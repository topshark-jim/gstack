---
name: retro
description: Weekly engineering retrospective. Use when the user wants commit-history, session, hotspot, and delivery-trend analysis over the last day, week, or custom time window.
---
