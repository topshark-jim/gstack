...
description: Engineering plan review. Use when the user wants to lock in architecture, data flow, failure modes, diagrams, testing, and implementation risks before coding.
---
